...
<head> 
    ...
    <%-- Usaremos el mismo CSS que el de Compras para mantener consistencia --%>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/pages/Vendedor/registrar_venta.css">
...
<nav class="navbar-vendedor">
    <div class="navbar-vendedor__catalogo">
        <img src="${pageContext.request.contextPath}/assets/Imagenes/iconos/Seller.png" alt="Vendedor">
    </div>
    ...
    <a href="${pageContext.request.contextPath}/index.jsp" class="navbar-admin__home-link">
        <span class="navbar-admin__home-icon-wrap">
            <i class="fa-solid fa-house-chimney"></i>
            <span class="navbar-admin__home-text">Inicio</span>
        </span>
    </a>
</nav>
    ...
    <div class="form-card">
        ...
        <form action="VentaServlet" method="POST" id="formVenta">
            ...
            <div class="section-title">
                <i class="fa-solid fa-user-tag"></i> Información del Cliente
            </div>
            
            <div class="form-row">
                <div class="form-group">
                    <label><i class="fa-solid fa-user"></i> Nombre del Cliente</label>
                    <input type="text" name="clienteNombre" placeholder="Nombre completo" required>
                </div>
                <div class="form-group">
                    <label><i class="fa-solid fa-phone"></i> Teléfono</label>
                    <input type="text" name="clienteTelefono" placeholder="Ej: 300 123 4567">
                </div>
                <div class="form-group">
                    <label><i class="fa-regular fa-calendar-check"></i> Fecha</label>
            ...
            <div class="form-group">
                ...
                <select name="metodoPago" required class="form-control">
                    ...
                    <option value="Transferencia">Transferencia / Nequi /Bancolombia o Daviplata</option>
                </select>
            </div>
            <%-- SECCIÓN PRODUCTOS --%>
            <div class="section-title">
                <i class="fa-solid fa-boxes-stacked"></i> Productos en la Venta
            ...
            <div class="bottom-bar">
                <button type="button" class="btn-add-row" id="btnAgregarProducto">
                    <i class="fa-solid fa-magnifying-glass-plus"></i> Buscar Producto
                </button>
                
                <div class="totales-resumen">
                    <div class="resumen-item">
                        <span>Anticipo:</span>
                        <input type="number" name="anticipo" class="input-mini" value="0" min="0">
                    </div>

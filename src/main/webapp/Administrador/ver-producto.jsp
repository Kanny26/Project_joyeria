...
<main class="product-page">
    <section class="product-card">
        ...
        <div class="product-details">
            ...
            <div class="product-row">
                <span class="product-label">Subcategoría</span>
                <span class="product-info-text">
                    <%= producto.getSubcategoriaNombre() != null && !producto.getSubcategoriaNombre().isEmpty()
                        ? producto.getSubcategoriaNombre() : "Sin subcategoría" %>
                </span>
            </div>

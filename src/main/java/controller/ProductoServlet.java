...
public class ProductoServlet extends HttpServlet {
    ...
    private void guardarProducto(HttpServletRequest request, HttpServletResponse response) 
        ...
        // ■■ CORRECCIÓN: Pasar usuarioId para registro en inventario ■■
    ...
    private void eliminarProductoPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            // ■■ RF14: Validar si hay ventas asociadas (no eliminar si hay) ■■
            // Esto debería validarse también con una consulta a Detalle_Venta
    ...
    private String validarProducto(Producto p) {
        ...
        // ■■ RF13: Validación precio venta ≥ costo ■■
    ...
    private void confirmarEliminar(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            // ■■ RF14: Validar si hay productos con ventas antes de eliminar ■■
            // Esto debería consultarse a la BD
